     ...
     <div class="  hero-section-xr ms-auto">
         <div class="p-4">
                             ...
                             <div class="card px-4  pb-3">
                                 ...
                                 <div class="row  borx py-4 ps-2 border-bottom">
                                     ...
                                     <div class="col-12 col-lg-9 p-0 d-flex">
                                         ...
                                         <!---company logo----->
                                         <div class=" my-auto">
                                             <img src="../company/assets/img/admin.png" class="hig-image"
                                                 alt="">
                                         </div>
                                         <!----message------->
                                         <div class="ps-3">
                                             <div class="py-0">
                                                 <div class=""> <span
                                                         class="fw-bold"><?php echo $row['admin_name']; ?> </span>
                                     ...
                                     <div class="col-12 col-lg-3  d-flex mt-md-2 mt-lg-3">
                                         ...
                                         <div class="d-flex btnx-w m-auto me-0">
                                             <a href="./all_single_feedback.php?replay_id=<?php echo $row['areplay_id']; ?>">
                                                 <button class="btn  bg-x1 m-1">
                                                     <i class="fa-solid fa-eye"></i>
                                                 </button>
                                             </a>
                                             <form action="php_code.php" method="post">
                                             <input type="hidden" name="complaint_replay_id" value=<?php echo $row['areplay_id']; ?>>
                                             <button class="btn btn-bg-x1 p-2 px-4 m-1"  name="delete_admin_replay">
                         ...
                         <div class="mx-2 my-4">
                             <div class="card px-4  pb-3">
                                 ...
                                 <?php
                                                                ...
                                                                "WHERE  admin_register.id = replay_complaint.company_id";
                                                              $result = mysqli_query($conn, $sql);
                                 ...
                                 <div class="row  borx py-4 ps-2 border-bottom">
                                     ...
                                     <div class="col-12 col-lg-9 p-0 d-flex">
                                         ...
                                         <!---company logo----->
                                         <div class=" my-auto">
                                             <img src="../company/company_logo/<?php echo $row['Image']; ?>" class="hig-image"
                                                 alt="">
                                         </div>
                                         <!----message------->
                                         <div class="ps-3">
                                             <div class="py-0">
                                                 <div class=""> <span
                                                         class="fw-bold"><?php echo $row['company_name']; ?> </span>
                                                     <span class=""><?php echo $row['create_at']; ?></span>
                                                     <div>
                                                         <span class="fw-bold">to-</span>
                                     ...
                                     <div class="col-12 col-lg-3  d-flex mt-md-2 mt-lg-3">
                                         <!------buttons------>
                                         <div class="d-flex btnx-w m-auto me-0">
                                             <a href="./replay_complaint.php?name=<?php echo urlencode ($company_name); ?>&id=<?php echo urlencode ($replay_id); ?>">
                                                 <button class="btn  bg-x1 m-1">
                                                     <i class="fa-solid fa-pen-to-square"></i>
                                                 </button>
                                             </a>
                                             <a
                                                 href="./user_single_feedback.php?id=<?php echo $row['replay_id']; ?>">
                                                 <button class="btn  bg-x1 m-1">
                                                     <i class="fa-solid fa-eye"></i>
                                                 </button>
                                             </a>
          ...
          $sql = "SELECT * " .
            ...
            "WHERE  user_register.user_id = use_complaint.user_id";
          $result = mysqli_query($conn, $sql);
         ...
         ?>
                ...
                ?>
                                         ...
                                         <div class="ps-3">
                                             <div class="py-0">
                                                 <div class=""> <span class="fw-bold"><?php echo $row['fname']; ?>
                                     ...
                                     <div class="col-12 col-lg-3  d-flex mt-md-2 mt-lg-3">
                                         ...
                                         <div class="d-flex btnx-w m-auto me-0">
                                             ...
                                             <a
                                                 href="./all_single_feedback.php?id=<?php echo $row['complaint_id']; ?>">
                                                 <button class="btn  bg-x1 m-1">
                                                     <i class="fa-solid fa-eye"></i>
                                                 </button>
                                             </a>
