 ...
 <?php 
          ...
          if (isset($_GET['id'])) {
            ...
            "WHERE  admin_register.id = replay_complaint.company_id AND compaint_id = $id";
                        ...
                        <div class="col-xl-4 d-md-flex d-xl-block">
                            ...
                            <div class="card mb-4 col-12 col-md-5 col-xl-12 m-auto">
                                <div class="card-body text-center">
                                    <img src="company_logo/<?php echo $data['Image']; ?>" alt="avatar" class="rounded-circle img-fluid" style="width: 150px; height:150px;">
