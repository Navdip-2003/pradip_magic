            ...
            <table class="table table-bordered mb-0 text-center" id="dataTable" width="100%" cellspacing="0">
                <thead>
                    <tr>
                        ...
                        <th class="blue-star-2">Phone Number</th>
                        <th class="blue-star-2">Message</th>
                ...
                <tbody>
                <?php
							$selectquery =mysqli_query($conn, "SELECT * FROM user_contact");
                    ...
                    <tr>
                        ...
                        <form action="php_code.php" method="post">
                                                ...
                                                <button class="btn btn-bg-x1 p-2 px-4 m-1" name="delete_user_contact">
