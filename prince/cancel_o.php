      ...
      <div class="container  h-100 my-2  card card-registration">
        <div class="row d-flex align-items-center justify-content-center h-100 ">
          ...
          <div class="col-md-8 col-lg-5 col-xl-5 mt-3 mt-xl-0 p-4">
            ...
            <form class="mt-3 p-lg-2 pt-0  ">
             
              <textarea name="" id="" class=" mb-4 h-textarea p-2 form-control" placeholder="Reason for cancel order..."></textarea>
             

             
              <!-- Submit button -->
              <button type="submit" class="btn bg-x1 btn-lg btn-block">Cancel Order</button>
