                                    ...
                                    <div class="container  h-100 my-2  card card-registration">
                                        <div class="row d-flex align-items-center justify-content-center h-100 ">
                                            ...
                                            <div class="col-md-8 col-lg-9 col-xl-6 mt-2 mt-xl-0 px-4">
                                                ...
                                                <form class="w-100" action="code.php" method="POST">
                                                    <!-- Name input -->
                                                    <div class="form-outline mb-4">
                                                        <input type="hidden" name="customer_id" value="<?php echo $id ?>">
                                                        <input type="hidden" name="user_id" value="<?php echo $user_id ?>">
                                                        <input type="text" name="customer_name" id="form4Example1" class="form-control" />
                                                        <label class="form-label" for="form4Example1">Customer
                                                            Name</label>
                                                    </div>
