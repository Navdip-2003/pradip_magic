...
<div class="d-flex">
    <div class="  hero-section-xr ms-auto">
        <div class="p-4">
            <div class="d-flex">
                <a href="./FeedBack.php" class="color-x1">
                    <p><span class="me-2"><i class="fa-solid fa-arrow-left"></i></span>Back to FeedBack</p>
                </a>
            </div>
            <div class="py-3">
                <?php 
         ...
         ?>
                ...
                ?>
                                <h5 class="my-3 ">From : <span class="text-x"><?php echo $row['fname']; ?>
                                        <?php echo $row['lname']; ?></span></h5>
         ...
         ?>
                        <div class="card mb-4 col-12 col-md-5 col-xl-12 m-auto">
                            <div class="card-body text-center">
                                <img src="../company/company_logo/<?php echo $data['Image']; ?>" alt="avatar"
                                    class="rounded-circle img-fluid" style="width: 150px;">
                                <h5 class="my-3 ">To : <span class="text-x"><?php echo $data['company_name']; ?></span>
                                </h5>
                    ...
                    <div class="col-xl-4 d-md-flex d-xl-block">
                        ...
                        <div class="card mb-4 col-12 col-md-5 col-xl-12 m-auto">
                            <div class="card-body text-center">
                                ...
                                <img src="../company/assets/img/admin.png" alt="avtar" class="rounded-circle img-fluid"
                                    style="width: 150px;">;

                                <h5 class="my-3 ">From : <span class="text-x"><?php echo $row['admin_name']; ?></span>
                                </h5>
