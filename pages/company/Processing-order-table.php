            ...
            <thead>
                ...
                <?php
                  ...
                  if($search){
                      ...
                      // }
                      // else{
                          $selectquery ="SELECT * FROM payments,product_page WHERE payments.track_order = 'Panding' AND payments.pid = product_page.product_id AND product_page.company_id = '$ids'";
                      // }
                      
                  }
                // $ids = $_SESSION['id'];
				// 			$selectquery =mysqli_query($conn, "SELECT * FROM payments,product_page WHERE payments.track_order = 'Panding' AND payments.pid = product_page.product_id AND product_page.company_id = '$ids'");
