    ...
    <section>
      <div class="py-3">
        ...
        <div class="row">
          <div class="col-xl-4">
            <div class="card mb-4">
              <div class="card-body text-center">
                ...
                <h5 class="my-3 color-x1">Loreal Group</h5>
          ...
          <div class="col-xl-8 ">
             <div class=" card">
               <div class="py-2 border-bottom mx-3"> <h5 class="my-3 color-x1">Loreal Group</h5></div>
               <div class="notX py-2 ms-3">

                <div class="mt-1">
                  <p class="tit-x mb-1"><span><i class="fa-solid fa-arrow-right color-x1 me-2"></i></span>Get 10% flat off on your first order</p>
                 <p>
