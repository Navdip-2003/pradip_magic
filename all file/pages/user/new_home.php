						...
						<li class="account">
							<div class="dropdown">
								...
								<ul class="dropdown-menu bg-dark" aria-labelledby="dropdownMenuLink">
								  <li class="w-100"><a href="ulogin.html" class="p-3 ps-5"><i class="fa fa-sign-in" aria-hidden="true"></i>Sign In</a></li>
								  <li class="w-100"><a href="userregi.html" class="p-3 ps-5"><i class="fa fa-user-plus" aria-hidden="true"></i>Register</a></li>
								</ul>
							  </div>
          ...
          <!-- <div class="col-12 col-lg-5">
            <div class="header-search">
              <form class="row bx ">
                ...
                <input class="input col col bx" placeholder="Search here">
