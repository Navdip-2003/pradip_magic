...
<?php
 ...
 <?php 
          ...
          $sql = "SELECT * " . 
            ...
            "WHERE admin_register.id = replay_complaint.company_id AND replay_id = $id";
          $result = mysqli_query($conn, $sql);
    
          if (mysqli_num_rows($result)) {
    
            while ($row = mysqli_fetch_assoc($result)) {
                $complaint_id = $row['compaint_id'];
         ?>
                    <div class="row">
                        <div class="col-xl-4 d-md-flex d-xl-block">
                            ...
                            <div class="card mb-4 col-12 col-md-5 col-xl-12 m-auto">
                                ...
                                <img src="../company/company_logo/<?php echo $row['Image']; ?>" alt="avatar" class="rounded-circle img-fluid" style="width: 150px;">
                                    ...
                                    <h5 class="my-3 ">From : <span class="text-x"><?php echo $row['company_name']; ?></span></h5>
        ...
        $sql = "SELECT * " . 
          ...
          "WHERE user_register.user_id = use_complaint.user_id AND complaint_id = $complaint_id";
        $result = mysqli_query($conn, $sql);
       ...
       ?>
                            <div class="card mb-4 col-12 col-md-5 col-xl-12 m-auto">
                                <div class="card-body text-center">
                                    <!-- <img src="../img/prince.jpg" alt="avatar" class="rounded-circle img-fluid" -->
                                    <?php
                if($data['user_image'] == ''){
                  echo '<img src="../../img/upload/user.png" alt="avtar" class="rounded-circle img-fluid" style="width: 150px; height:150px">';
                }else{
                  echo '<img src="../user/uploaded_img/'.$data['user_image'].'" alt="avatar" class="rounded-circle img-fluid" style="width: 150px;height:150px;">';
                }
                ?>
                
                                      
                                    <h5 class="my-3 ">To : <span class="text-x"><?php echo $data['fname']; ?> <?php echo $data['lname']; ?></span></h5>
                                ...
                                <div class="card mb-4  mt-4 ">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                <p class="text-muted mb-0"><?php echo $row['re_subject']; ?></p>
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="row">
