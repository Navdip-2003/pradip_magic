    ...
    <div class="d-flex">
        <div class="  hero-section-xr ms-auto">
            ...
            if(isset($_GET['id'])){
                    $id  = $_GET['id'];
                    $selectquery = mysqli_query($conn, "SELECT * FROM product_page,category WHERE product_id=$id AND product_page.cat_id = category.cat_id");
    ...
    if(mysqli_num_rows($resMultipleImage)>0){
        ...
        while($rowMultipleImage=mysqli_fetch_assoc($resMultipleImage)){
            ...
            $jj++;
                ...
                <div class="row justify-content-center row-cols-xl-3 row-cols-lg-2 row-cols-md-3 row-cols-sm-2 row-cols-1 px-md-5 px-sm-3 px-xl-0">
                
                    <div class="col">
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label color-x1">Product Name</label>
                            <input type="text" class="form-control p-1" name="name" value="<?= $data['product_name']; ?>" placeholder="Enter Product Name" id="exampleInputEmail1"
                    ...
                    <div class="col">
                        <div class="mb-3">
                            ...
                            <input list="brow" name="country" value="<?= $data['country']; ?>" class="form-control">
                            <datalist id="brow">
                    ...
                    <div class="col-12 col-xl-4" id="image_box">
                        <div>
                            ...
                            <label for="">Current Image</label>
								...
								<img src="multi_images/<?= $data['img'];?>" height="50px" width="50px" alt="<?= $data['product_name']; ?>" srcset="">
                        </div>
                        <div class="mt-3 d-flex justify-content-center color-x1">
                            <button id="" type="button" class="btn btn-lg btn-bg-x1 btn-block m-0 pt-1" onclick="add_more_images()">
...
foreach($multipleImageArr as $list){
	...
	<button type="button" class="btn btn-lg btn-danger btn-block"><span id="payment-button-amount">
	<a href="edit-product.php?id='.$id.'&pi='.$list['id'].'" style="color:white;">Remove</span></button></a>';
	echo "<a target='_blank' href='".$pathh.$list['product_images']."'><img width='50px' height='50px' src='".$pathh.$list['product_images']."'/></a>";
	echo '<input type="hidden" name="product_images_id[]" value="'.$list['id'].'"/><input type="hidden" name="old_product_images[]" value="'.$list['product_images'].'"/></div>';
                    ...
                    <div class="col-12 col-xl-8">
                        <div class="row mt-3 mt-xl-0">
                            <div class="col-12 col-md-6">
                                ...
                                <textarea name="subtitle" id="" cols="" rows=""  placeholder="Title..."
                                    class="w-100 form-control mt-2 title-dis"><?= $data['subtitle']; ?></textarea>
                            </div>
                            <div class="col-12 col-md-6">
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label color-x1">Original Price</label>
                                    <input type="text" name="origanal_price" class="form-control p-1" value="<?= $data['dis_price']; ?>" id="exampleInputEmail1"
                                        aria-describedby="emailHelp">
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label color-x1">Discount</label>
                                    <input type="text" name="offer" class="form-control p-1" id="exampleInputEmail1"
                                        aria-describedby="emailHelp">
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label color-x1">saling Price</label>
                                    <input type="text" name="selling_price" value="<?= $data['price']; ?>" class="form-control p-1" id="exampleInputEmail1"
                                        aria-describedby="emailHelp">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label color-x1">Company</label>

                            <input list="brow" name="company"  class="form-control">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                ...
                                <div class="form-group ">
                                    <textarea id="" type="text" name="description"  class="detail-dis form-control"><?= $data['description']; ?></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row ">
                            ...
                            <div class="col-12 col-md-6 mt-2">
                                ...
                                <textarea name="address" id="" cols="" rows="" placeholder="Write..."
                                    class="w-100 form-control mt-2 title-dis"><?= $data['Address']; ?></textarea>
                            </div>
                        </div>
                               <div class="row">
                                <div class="col-12 col-md-6 mt-2">
                        ...
                        <div class="d-flex my-4 justify-content-center">
                            ...
                            <input type="submit" class="btn bg-x1 mx-2" name="update_product_btn" value="Add Product">
                            <!-- <button type="submit" class="btn bg-x1 mx-2" name="update_product_btn">Update</button> -->
                        </div>
                        <div class="col-md-12">
