            ...
            <thead>
              ...
              if($search){
                 ...
                 //  $ids = $_SESSION['id'];
                  ...
                  // }
                  // else{
                      $selectquery ="SELECT * FROM payments WHERE payments.Status = 'cancel' AND payments.track_order = 'Completed'";
                  // }
                  
              }
							$selectquery =mysqli_query($conn, "SELECT * FROM payments WHERE payments.Status = 'cancel' AND payments.track_order = 'Completed'");
