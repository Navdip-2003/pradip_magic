    ...
    <section class=" ">
      <div class="container  h-100 my-4 card card-registration">
        <div class="row d-flex align-items-center justify-content-center h-100 ">
          ...
          <div class="col-md-8 col-lg-5 col-xl-6 col-xxl-6 mb-4 mb-xxl-0 px-5 px-md-0 px-xxl-5">
            ...
            <form class="mt-4 mt-md-0 ">
              ...
              <div class="form-outline mb-4">
                <input type="email" id="form1Example13" class="form-control form-control-lg" disabled/>
              ...
              <div class="d-flex mb-4">
               ...
               <!-- Email input -->
               <div class="form-outline mb-4">
                <textarea name="" id="form1Example13" class=" mb-4 h-textarea p-2 form-control" ></textarea>
              ...
              <!-- Submit button -->
              <button type="submit" class="btn bg-x1 btn-lg btn-block">EDIT Profile</button>
