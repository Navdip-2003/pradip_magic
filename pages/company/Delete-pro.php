<?php
    ...
    <div class="d-flex">
        <div class="  hero-section-xr ms-auto">
            <div class="p-4">
                <div class="d-flex">
                    <a href="./dashbord.html" class="color-x1">
                        <p><span class="me-2"><i class="fa-solid fa-arrow-left"></i></span>Back to Deshbord</p>
                    </a>
                </div>
                <div class="d-flex p-3 card mb-4">
                    <h2 class="m-auto">Deleted Products</h2>
                </div>
                <div
                    class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-2 row-cols-xl-3 row-cols-xxl-4 g-3 g-lg-4 px-4 px-sm-0">

<?php
$ids = $_SESSION['id'];
             $Selectquery ="SELECT * FROM product_page WHERE delete_status = 'inactive' AND company_id = '$ids'";
                          ...
                          <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between">
                              ...
                              <div class="d-flex alert-danger">
                                    <p class="m-auto color-x1">Product was deleted !</p>
                                </div>
