            ...
            <thead>
                ...
                <?php
                 ...
                 if($search){
                     ...
                     // }
                     // else{
                         $selectquery ="SELECT * FROM payments,product_page WHERE payments.Status = 'cancel' AND payments.track_order = 'Completed' AND payments.pid = product_page.product_id AND product_page.company_id = '$ids'";
                     // }
                     
                 }
                // $ids = $_SESSION['id'];
				// 			$selectquery =mysqli_query($conn, "SELECT * FROM payments,product_page WHERE payments.Status = 'cancel' AND payments.track_order = 'Completed' AND payments.pid = product_page.product_id AND product_page.company_id = '$ids'");
                ...
                if(mysqli_num_rows($selectquery_run) > 0){
                    ...
                    <tr>
                        ...
                        <td><span class="bg-cancel m-0 p-1 px-3 bor-r">Cancelled</span></td>
